...
## Sensors
 1. *DHT11 Humidity & Temperature Sensor* – Monitors the air humidity and temperature inside the main food storage container to prevent the kibbles from getting stale or spoiled.
 2. *HC-SR04 Ultrasonic Sensor* – Detects the presence of an object or food level within a 5cm range in the food bowl area.
 3. *LDR (Light Dependent Resistor) Sensor* – Detects ambient light exposure to determine whether the surrounding environment is bright or dark.
 4. *MQ-Series Gas Sensor* – Monitors the odor/gas levels around the feeding area to detect waste or bad smell.
## Actuators
